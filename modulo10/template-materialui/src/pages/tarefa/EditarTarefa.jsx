...
const EditarTarefa = forwardRef(
  ({ handleCloseEditar, tarefa, setTarefas }, ref) => {
    ...
    const handleEditar = () => {
      setTarefas(tarefas =>
        tarefas.map(obj => {
          if (obj.idTarefa === tarefa.idTarefa) {
    ...
    return (
      <Grid tabIndex="-1" container spacing={2} ref={ref}>
        <Card sx={style}>
            ...
            <Grid container spacing={2} mt={1}>
              ...
              <Grid item xs={3}>
                <FormControl fullWidth>
                  ...
                  >
                    {Object.keys(enumRecursoTarefa).map(keyEnum => (
                      <MenuItem
                        key={keyEnum}
                        value={enumRecursoTarefa[keyEnum]}
                      >
                        {enumRecursoTarefa[keyEnum]}
                      </MenuItem>
                    ))}
                  </Select>
                </FormControl>
              ...
              <Grid item xs={3}>
                <FormControl fullWidth>
                  ...
                  >
                    {Object.keys(enumStatusTarefa).map(keyEnum => (
                      <MenuItem key={keyEnum} value={enumStatusTarefa[keyEnum]}>
                        {enumStatusTarefa[keyEnum]}
                      </MenuItem>
                    ))}
                  </Select>
                </FormControl>
...
EditarTarefa.displayName = 'EditarTarefa'
